...
@Component({
  ...
  template: `
    <div class="details">
    <button class="primary" id="return" [routerLink]="['/']">←Return</button>
...
export class DetailsComponent {
  ...
  TitansService = inject(TitansService);
  product: Product | undefined;

  constructor() {
    const TitanItemsId = Number(this.route.snapshot.params['id']);
    this.TitansService.getProductById(TitanItemsId).then(product => {
